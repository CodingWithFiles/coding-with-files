...
Centralized blocker handling guidance for all CIG workflow phases. This document consolidates common blockers, reversion strategies, and decomposition signals that were previously duplicated across workflow commands.
...
2. Create subtasks using `/cig-subtask <parent> <num> <type> "description"`
...
For workflow step details, see `.cig/docs/workflow/workflow-steps.md`

...
| **worktree** | Working directory path | 95 | `~/cig-task-37/` → task 37 |
| **state** | Explicit state file | 85 | `.cig/current-task` = "37" |
...
| **command_context** | Command invoked | 80 | `/cig-testing` → e-testing-plan |
...
**Module**: `.cig/lib/TaskContextInference.pm`
...
**Wrapper**: `.cig/scripts/command-helpers/task-context-inference`
...
- **Design docs**: `.cig/docs/design/` (detailed signal specifications, scoring algorithms)

package CIG::Options;
#
# CIG::Options - Simple command-line option parser for CIG helper scripts
#
...
CIG::Options provides a simple, dependency-free command-line option parser
for CIG helper scripts. It supports long options (--option), short options (-o),

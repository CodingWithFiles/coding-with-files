package CIG::ContextInheritance::Core;

=head1 NAME

CIG::ContextInheritance::Core - Version-agnostic context inheritance logic

=head1 SYNOPSIS

    use CIG::ContextInheritance::Core;

    my @parent_data = CIG::ContextInheritance::Core::generate_context(\@parent_tasks, $workflow_mappings);
...
Parameters:
  ...
  $workflow_mappings  - Array of workflow file mappings from CIG::WorkflowFiles

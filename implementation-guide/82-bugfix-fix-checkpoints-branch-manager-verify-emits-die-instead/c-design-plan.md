# Fix checkpoints-branch-manager verify emits die instead of warn on SIGPIPE - Design
**Task**: 82 (bugfix)
...
## Goal
Define architecture and design decisions for Fix checkpoints-branch-manager verify emits die instead of warn on SIGPIPE.

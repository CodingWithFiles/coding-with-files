# enforce single canonical task type list across CWF modules - Design
**Task**: 81 (bugfix)
...
## Goal
Define architecture and design decisions for enforce single canonical task type list across CWF modules.

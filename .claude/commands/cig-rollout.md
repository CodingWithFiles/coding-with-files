...
After completing the rollout phase, create a checkpoint commit to preserve progress:
...
See `.cig/docs/workflow/workflow-steps.md#rollout` for detailed checkpoint commit guidance.
